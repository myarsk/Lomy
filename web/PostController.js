...
const AdMediaRepository = require('../repository/AdMediaRepository');
const MediaRepository = require('../repository/MediaRepository');
const PostRepository = require('../repository/PostRepository');
const {save} = require('../repository/PostRepository');
const CreatePostDTO = require('../dto/CreatePostDTO');
const Visible = CreatePostDTO.visible
const visible = Visible;
const country = 'USA';
const tag = 'Technology';
const type = 'News';
const postText = 'This is a post about technology news.';
const rating = 5;
const isExperience = true;
const { createPost } = require('../service/PostService');
const createPostDTO = new CreatePostDTO(visible, country, tag, type, rating, postText, isExperience);
const words = createPostDTO.postText.split(' ');

// Create instances of services and repositories
const postService = new PostService(PostRepository);
const userService = new UserService();
const fileService = FileService.uploadFile;
const adMediaRepository = AdMediaRepository;
...
//const files = FileService.uploadFile;
